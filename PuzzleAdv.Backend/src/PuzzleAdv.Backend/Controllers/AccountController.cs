        ...
        public async Task<IActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await _emailSender.SendEmailAsync(model.Email, "Conferma il tuo account",
                        "Clicca sul seguente link per abilitare il tuo account PuzzleAdv: <a href=\"" + callbackUrl + "\">abilita account</a>");
